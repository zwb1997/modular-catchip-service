...
public class IpServiceConstant {
    ...
    public static final String ANONYMITY_TRANSPARENT = "透明";
    public static final byte USE_CODE = 1;
    public static final byte UNUSE_CODE = 0;
    public static final byte DEGREE_TRANSPARENT = 0;
